...
public class DegreePlannerView extends JFrameView{
    ...
    public DegreePlannerView(DegreePlannerModel model, MainController controller){
		...
		addCourseButton.setToolTipText("Subject CourseID Semester (ex: CS 1428 1)");
		...
		removeCourseButton.setToolTipText("Subject CourseID Semester (ex: CS 1428 1)");
		...
		addMajorButton.setToolTipText("MajorName (ex: Computer Science)");
		...
		removeMajorButton.setToolTipText("MajorName (ex: Computer Science)");
		...
		addMinorButton.setToolTipText("MinorName (ex: Mathematics)");
		...
		removeMinorButton.setToolTipText("MinorName (ex: Mathematics)");
